...
if __name__ == "__main__":
    s = r"""
    tonic::transport::server::SvcFuture<tonic::service::recover_error::ResponseFuture<tower::util::either::EitherResponseFuture<tower::load_shed::future::ResponseFuture<tower::util::either::EitherResponseFuture<CHAIN<tower::limit::concurrency::future::ResponseFuture, tonic::transport::service::grpc_timeout::ResponseFuture, tower::limit::concurrency::future::ResponseFuture, Box, Future, http::response::Response, tonic::body::Body>, CHAIN<tonic::transport::service::grpc_timeout::ResponseFuture, tower::limit::concurrency::future::ResponseFuture, Box, Future, http::response::Response, tonic::body::Body>>>, tower::util::either::EitherResponseFuture<CHAIN<tower::limit::concurrency::future::ResponseFuture, tonic::transport::service::grpc_timeout::ResponseFuture, tower::limit::concurrency::future::ResponseFuture, Box, Future, http::response::Response, tonic::body::Body>, CHAIN<tonic::transport::service::grpc_timeout::ResponseFuture, tower::limit::concurrency::future::ResponseFuture, Box, Future, http::response::Response, tonic::body::Body>>>>>::poll
    """
