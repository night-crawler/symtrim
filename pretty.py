...
if __name__ == "__main__":
    s = r"""
    tonic::transport::server::SvcFuture<tonic::service::recover_error::ResponseFuture<tower::util::either::EitherResponseFuture<tower::load_shed::future::ResponseFuture<tower::util::either::EitherResponseFuture<CHAIN<Target = CHAIN<Target = tonic::body::Body, Path = (Box, Future, http::response::Response)>, Path = (tower::limit::concurrency::future::ResponseFuture, tonic::transport::service::grpc_timeout::ResponseFuture, tower::limit::concurrency::future::ResponseFuture)>, tonic::transport::service::grpc_timeout::ResponseFuture<tower::limit::concurrency::future::ResponseFuture<CHAIN<Target = tonic::body::Body, Path = (Box, Future, http::response::Response)>>>>>, tower::util::either::EitherResponseFuture<CHAIN<Target = CHAIN<Target = tonic::body::Body, Path = (Box, Future, http::response::Response)>, Path = (tower::limit::concurrency::future::ResponseFuture, tonic::transport::service::grpc_timeout::ResponseFuture, tower::limit::concurrency::future::ResponseFuture)>, tonic::transport::service::grpc_timeout::ResponseFuture<tower::limit::concurrency::future::ResponseFuture<CHAIN<Target = tonic::body::Body, Path = (Box, Future, http::response::Response)>>>>>>>::poll
    """
